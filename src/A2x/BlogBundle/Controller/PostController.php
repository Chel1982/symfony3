...
class PostController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $posts = $em->getRepository('A2xBlogBundle:Post')->findAll();
    ...
    {
        $post = new Post();
        $form = $this->createForm('A2x\BlogBundle\Form\PostType', $post);
    ...
    {
        $deleteForm = $this->createDeleteForm($post);
        $editForm = $this->createForm('A2x\BlogBundle\Form\PostType', $post);
